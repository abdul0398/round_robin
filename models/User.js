...
class User {
    ...
    static async create(userData) {
        const { name, email, password, role = 'agent', discordName, discordWebhook } = userData;
        ...
        try {
            ...
            const [result] = await pool.execute(
                `INSERT INTO users (name, email, password, role, discord_name, discord_webhook) 
                 VALUES (?, ?, ?, ?, ?, ?)`,
                [name, email, hashedPassword, role, discordName || null, discordWebhook || null]
            );
